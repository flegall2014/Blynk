...
public:
    enum Parameter {
        ...
        BLUE_CHANNEL_MIN_DEFAULT,
        BLUE_CHANNEL_MAX_DEFAULT,

        RED_CHANNEL_MIN_LIGHT,
        RED_CHANNEL_MAX_LIGHT,
        RED_CHANNEL_MIN_MEDIUM,
        RED_CHANNEL_MAX_MEDIUM,
        RED_CHANNEL_MIN_STRONG,
        RED_CHANNEL_MAX_STRONG,

        GREEN_CHANNEL_MIN_LIGHT,
        GREEN_CHANNEL_MAX_LIGHT,
        GREEN_CHANNEL_MIN_MEDIUM,
        GREEN_CHANNEL_MAX_MEDIUM,
        GREEN_CHANNEL_MIN_STRONG,
        GREEN_CHANNEL_MAX_STRONG,

        BLUE_CHANNEL_MIN_LIGHT,
        BLUE_CHANNEL_MAX_LIGHT,
        BLUE_CHANNEL_MIN_MEDIUM,
        BLUE_CHANNEL_MAX_MEDIUM,
        BLUE_CHANNEL_MIN_STRONG,
        BLUE_CHANNEL_MAX_STRONG
    };
